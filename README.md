...
1. All Analysis, CSV's and Python Code are uploaded into 
  GitHub, as instructed.

2.  Within the code, for some reason, some functionality 
   didn't work exactly as planned (i.e. print(f"string").
   So I had to take a minor poetic license.
